            ...
            <ul>
                ...
                <li>
                    <a href="<?= Yii::$app->urlManager->createUrl(["site/sites"]) ?>"
                       <?php if ($action == "sites") { ?>class="active"<?php } ?>>
                        Сайты учеников </a>
                </li>
                <li>
                    ...
                    <td id="right">
                                    ...
                                    <td id="right_minicourses_list">
                                                ...
                                                <tr>
                                                    <td class="arrow">
                                                        <img src="/web/images/left.png" alt="Влево"
                                                             onclick="changeMiniCourse(false, 'right_minicourses_list')"/>
                                                    </td>
                                                    <td class="arrow">
                                                        <img src="/web/images/right.png" alt="Вправо"
                                                             onclick="changeMiniCourse(true, 'right_minicourses_list')"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freefl.png"
                                                             alt="Инструкция по заработку на создании сайтов под заказ"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freewp.png"
                                                             alt="Пример создания блога на WordPress"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freehtml5.png"
                                                             alt="HTML5 и CSS3 для начинающих"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freephp2.png"
                                                             alt="Создание движка на PHP для начинающих"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freejs.png"
                                                             alt="Видеокурс по основам JavaScript"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/book.png"
                                                             alt="Создание сайта от начала и до конца"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freeim.png"
                                                             alt="Создание Интернет-магазина с нуля"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freemakeup.png"
                                                             alt="Мини-курс по вёрстке сайтов"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/freephp.png"
                                                             alt="Видеокурс по основам PHP"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                                        ...
                                        <div class="hide">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="center">
                                                        <img src="/web/images/courses/html.png"
                                                             alt="Видеокурс по основам HTML"/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p class="center">
                        ...
                        <div class="right_block">
                            <div class="online">
                                ...
                                <p><span>Как создать профессиональный Интернет-магазин?</span><br/>После данного
                                    семинара:</p>
                                <ul class="ul_mark">
                        ...
                        <div class="right_block">
                            ...
                            <div class="recommendation">
                                ...
                                <p>Один из лучших регистраторов доменных имен в рунете. Домен .RU и .РФ всего за 99
                                    рублей. Все домены покупаю только у них!</p>
                            </div>
                            <br/>
                            ...
                            <div class="recommendation">
                                ...
                                <p>На мой взгляд, лучший хостинг в Рунете. Я перепробовал много их, то они были
                                    медленными, то отключались часто, то была высокая цена. <a rel="external"
                                                                                               href="http://hostia.ru/billing/host.php?uid=11034">Hostia.ru</a>
                                    - это отличная скорость, высокая надёжность и при этом низкая цена (от 0.88$ в
                                    месяц).</p>
                            </div>
                        </div>
                    </td>
